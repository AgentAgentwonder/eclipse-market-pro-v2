    ...
    <div className="p-6 space-y-6 fade-in">
        ...
        <Card className="bg-card border-border border-accent">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-foreground">Paper Trading is currently disabled</p>
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          ...
          <CardDescription>
            {enabled ? 'Your virtual trading account' : 'Enable paper trading in settings to use this feature'}
          </CardDescription>
        </CardHeader>
        <CardContent>
